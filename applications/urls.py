...
from .views import get_applications, create_application, application_details, user_applications, update_notes
...
urlpatterns = [
    ...
    path('applications/<int:pk>/update-notes', update_notes, name='update_notes')
]